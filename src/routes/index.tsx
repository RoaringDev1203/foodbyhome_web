...
const AdminDrivers = lazy(() => import('../app/admin/(driver)/drivers/page'))
const AdminDriverDetails = lazy(() => import('../app/admin/(driver)/drivers/[driverId]/page'))
const AdminAddDriver = lazy(() => import('../app/admin/(driver)/add-driver/page'))
const AdminEditDriver = lazy(() => import('../app/admin/(driver)/edit-driver/page'))
...
const clientAccountRoutes: RoutesProps[] = [
  {
    path: '/cart',
    name: 'Cart',
    element: <Cart />
...
const adminRoutes: RoutesProps[] = [
  ...
  {
    path: "/admin/add-dish/:restaurantId",
    name: "Dashboard",
    element: <AdminAddDish />,
  },
  {
    path: "/admin/edit-dish/:foodId",
    name: "Dashboard",
