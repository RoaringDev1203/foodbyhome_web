  ...
  return (
    <>
      <div className="rounded-lg border border-default-200">
        <div className="p-6 pb-0">
          <div className="text-center mt-2">
            ...
            <h4 className="text-lg mt-2 mb-0 dark:text-gray-300">Foodbyhome N</h4>
            ...
            <div className="mt-7 pt-5 border-t text-start dark:border-gray-600">
              <p className="text-gray-500 mb-2 dark:text-gray-400">
                Hi I'm Foodbyhome. I am user experience and user type designer. I
      ...
      <div className="rounded-lg border border-default-200 relative">
        <img src={Img2} alt="Foodbyhome" className="w-full" />
      ...
      <div className="rounded-lg border border-default-200">
        <div className="p-6">
          <div className="flex gap-5">
            <img src={Img1} className="h-20 rounded-full" alt="Foodbyhome" />
          ...
          <div className="mt-1 pt-2 border-t text-start dark:border-gray-600">
            <p className="text-gray-500 mb-2 dark:text-gray-400">
              Hi I'm Foodbyhome. I am foodie and love to eat different cuisine!
            </p>
          </div>
      ...
      <div className="space-y-5">
        <div className="rounded-lg border border-default-200">
          <div className="grid md:grid-cols-3 items-center">
            <div>
              <img src={Img1} className="h-full" alt="Foodbyhome" />
            </div>
        ...
        <div className="rounded-lg border border-default-200">
          <div className="p-6">
            <div className="flex items-center gap-5">
              <img src={Img1} className="h-20 rounded" alt="Foodbyhome" />
              <div className="flex-grow-1">
                <h5 className="mt-1 mb-0 dark:text-gray-300">Foodbyhome N</h5>
                <h6 className="text-primary mt-1 mb-1">
                  <Link to="">@Foodbyhome</Link>
                </h6>
