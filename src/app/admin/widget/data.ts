...
const iconWidget: IconWidgetCard[] = [
  {
    text: 'Today Revenue',
    price: 851,
    icon: LuShoppingBag,
...
const valueWidget: ValueWidgetCard[] = [
  {
    text: 'Today Revenue',
    price: 6512,
    color: 'primary',
...
const cardWidget: ChartWidgetCard[] = [
  {
    text: 'Today Revenue',
    price: 2100,
    color: 'success',
...
const chartWidget: ChartWidgetCard2[] = [
  {
    text: 'Visits',
    amount: '21,000',
    chartColor: '#5369f8',
...
const teamWidget: TeamWidgetCard[] = [
  {
    img: Img1,
    name: 'Foodbyhome N',
...
const teamWidget2: TeamWidgetCard2[] = [
  {
    img: Img6,
    time: '10:00',
    name: 'Geneva',
...
const teamWidget3: TeamWidgetCard3[] = [
  {
  ...
  },
  {
    ...
    event: 'Foodbyhome v3 Scope Review',
  },
  {
...
const teamWidget4: TeamWidgetCard4[] = [
  {
    amount: '121,000',
    text: 'Total Visitors',
    icon: LuUsers,
...
const teamWidget5: TeamWidgetCard5[] = [
  {
  ...
  {
    text1: 'Write a release note for Foodbyhome',
    text2: 'Due on 22 Aug, 2019',
  },
  {
    text1: 'Invite Greeva to a project Foodbyhome admin',
...
const teamWidget6: TeamWidgetCard6[] = [
  {
    class: 'gap-3',
    img: Img1,
    name: 'Foodbyhome',
