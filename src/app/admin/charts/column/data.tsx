...
// Column with Markers
export const markersColumnChart: ApexOptions = {
  series: [
    {
      name: 'Actual',
      data: [
...
export const groupLabelColumnChart: ApexOptions = {
  series: [
    {
      name: 'Sales',
      data: [
...
export const labelsColumnChart: ApexOptions = {
  annotations: {
    points: [
      {
        x: 'Bananas',
...
export const negativeValuesColumnChart: ApexOptions = {
  chart: {
    height: 380,
    type: 'bar',
    toolbar: {
