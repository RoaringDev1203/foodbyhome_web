...
export const barNegativeValueChart: ApexOptions = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const customDataLabelsBarChart: ApexOptions = {
  chart: {
    height: 450,
    type: 'bar',
  },
...
// Patterned Bar Chart
export const patternedBarChart: ApexOptions = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
// Bar with Markers
export const markersBarChart: ApexOptions = {
  series: [
    {
      name: 'Actual',
      data: [
