...
const data: any = generateDayWiseTimeSeries(
...
// Simple line chart
export const simpleLineChart: ApexOptions = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
export const dataLabelsLineChart: ApexOptions = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
// Zoomable Timeseries
export const zoomableTimeseriesChart: ApexOptions = {
  chart: {
    type: 'area',
    stacked: false,
    height: 380,
...
export const annotationsLineChart: ApexOptions = {
  annotations: {
    yaxis: [
      {
        y: 8200,
...
// Syncing charts
export const syncingLineChart: ApexOptions = {
  chart: {
    height: 200,
    type: 'line',
    id: 'yt',
...
export const syncingLineChart2: ApexOptions = {
  chart: {
    type: 'line',
    height: 160,
    id: 'fb',
...
// Missing / Null values
export const nullLineChart: ApexOptions = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
// Brush Chart
export const brushLineChart: ApexOptions = {
  series: [
    {
      data: data,
    },
...
export const brushLineChart2: ApexOptions = {
  series: [
    {
      data: data,
    },
