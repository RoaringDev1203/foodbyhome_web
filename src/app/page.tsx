          ...
          <div className="container">
            <nav className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <Link to="/">
                  <img src={logoDarkImg} width={130} height={70} alt="logo" className="flex h-16 dark:hidden" />
                  <img src={logoLightImg} width={130} height={700} alt="logo" className="hidden h-16 dark:flex" />
                </Link>
              </div>
      ...
      <section className="bg-default-50/80 py-20" id="features">
        <div className="container">
          ...
          <p className="mt-6 text-center text-base font-medium text-primary-900 dark:text-primary">
            All these sounds Foodbyhomemy, right? Wait until you purchase it. 😉
          </p>
        </div>
      </section>
      <footer style={{ backgroundImage: `url(${offerBgOtherImg})` }} className="relative">
        ...
        <div className="container relative">
          <p className="py-6 text-center font-medium text-default-900">
            © Foodbyhome. Crafted and Coded with <span className="text-red-500">❤️</span> by{' '}
