...
import { DishType } from "@/types/food";
      ...
      <section className="py-6 lg:py-10">
        <div className="container">
          ...
          <div className="pt-10">
            ...
            {consumerReviews.map((review, idx) => (<div key={review.id}
              className={cn("py-5", consumerReviews.length !== idx + 1 && "border-b border-default-200")}>
              <div className="mb-3 flex items-center">
                <img src={review.reviewer_image} alt="avatar" height={48} width={48}
                ...
                <div>
                  ...
                  <div className="flex gap-1.5">
                    ...
                    {review.stars < 5 && Array.from(new Array(5 - Math.ceil(review.stars))).map((_val, idx) => (
