...
const TestimonialsSwiper = ({ reviews }: { reviews: TestimonialType[] }) => {
  ...
  return (
    <div>
      <span className="mb-6 inline-flex rounded-full bg-primary/20 px-4 py-2 text-sm text-primary">Anmeldelser</span>
      <h2 className="mb-4 max-w-xl text-3xl font-semibold text-default-900">Hvad de siger om os.</h2>
