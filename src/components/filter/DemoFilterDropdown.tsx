...
const DemoFilterDropdown = ({ filterType, filterOptions,buttonClassName }: DemoFilterDropdownType) => {
  ...
  return (
    <div className="hs-dropdown relative inline-flex">
      <button
        type="button"
        className={cn( "hs-dropdown-toggle flex items-center gap-2 rounded-md bg-default-100 px-4 py-3 text-sm font-medium text-default-700 transition-all xl:px-5",buttonClassName)}
      >
