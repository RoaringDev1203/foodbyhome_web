  ...
  return (
    <header className="sticky top-0 z-40 flex h-18 w-full border-b border-default-200 bg-white dark:bg-default-50 lg:ps-64 hide-in-print">
      <nav className="flex w-full items-center gap-4 px-6">
        ...
        <div className="flex lg:hidden">
          <Link to="/home">
            <img src={logoDarkImg} height={100} width={130} alt="logo" className="flex h-20 w-full dark:hidden" />
            <img src={logoLightImg} height={120} width={130} alt="logo" className="hidden h-20 w-full dark:flex" />
          </Link>
        </div>
