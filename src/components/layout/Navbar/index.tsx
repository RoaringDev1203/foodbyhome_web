    ...
    <>
          ...
          <div className="container">
            <div className="grid grid-cols-2 items-center gap-4 lg:grid-cols-3">
              <div className="flex">
                ...
                <Link to="/home">
                  <img src={logoDarkImg} height={170} width={130} alt="logo" className="flex h-16 dark:hidden" />
                  <img src={logoLightImg} height={170} width={130} alt="logo" className="hidden h-16 dark:flex" />
                </Link>
              </div>
      ...
      >
        <div className="flex h-16 items-center justify-center border-b border-dashed border-default-200 transition-all duration-300">
          <Link to="/home">
            <img src={logoDarkImg} width={130} height={140} alt="logo" className="flex h-10 dark:hidden" />
            <img src={logoLightImg} width={130} height={170} alt="logo" className="hidden h-10 dark:flex" />
          </Link>
        </div>
